...
//  DropDemo
//
//  Created by Eric Ho on 24/9/2017.
...
class ThumbnailZoomTransitionAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        UIView.animate(withDuration: duration, delay: 0.0, usingSpringWithDamping: 1, initialSpringVelocity: 1.0, options: [UIViewAnimationOptions.curveEaseInOut], animations: {
            ...
            if presenting {
                ...
                storyDetailView.transform = CGAffineTransform.identity
            }
            else {
                // Return the master view to its inherent size and position and shrink the detail view.
                storyFeedView.transform = CGAffineTransform.identity
                storyDetailView.transform = CGAffineTransform(scaleX: shrinkScaleFactor, y: shrinkScaleFactor)
            }
